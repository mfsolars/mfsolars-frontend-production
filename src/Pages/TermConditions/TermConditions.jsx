...
function TermConditions() {
    return ( <>
    <div className="main-page-wrapper mfsolars-m4PO4" style={{marginTop:"2rem", padding:"1rem 0",background:"aliceblue"}}>
  <div className="container">
    <div className="row content-layout-wrapper align-items-start">
      <div className="site-content col-lg-12 col-12 col-md-12" role="main">
        <article
          id="post-13889"
          className="post-13889 page type-page status-publish hentry"
        >
          <div className="entry-content">
            <h2 className="wp-block-heading" id="h-terms-and-conditions">
              Terms and Conditions
            </h2>
            <h4 className="wp-block-heading" id="h-welcome-to-invertsolar">
              Welcome to Invertsolar!
            </h4>
            <p>
            ...
            <p>
              ...
              conditions. Do not continue to use Invertsolar if you do not agree
            ...
            <p>
              ...
              subject to, prevailing law of za. Any use of the above terminology
            ...
            <p>
              We employ the use of cookies. By accessing Invertsolar, you agreed
              to use cookies in agreement with the Invert Solar’s Privacy
              Policy.{" "}
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, Invert Solar and/or its licensors own the
              intellectual property rights for all material on Invertsolar. All
              intellectual property rights are reserved. You may access this
              from Invertsolar for your own personal use subjected to
            ...
            <ul className="wp-block-list">
              <li>&nbsp;&nbsp;&nbsp;Republish material from Invertsolar</li>
              <li>
              ...
              <li>&nbsp; Redistribute content from Invertsolar</li>
            </ul>
            <p>
              This Agreement shall begin on the date hereof. Our Terms and
              Conditions were created with the help of the &lt;a to=”
              <Link
            ...
            <p>
              ...
              Invert Solar does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Invert Solar,its agents and/or
              ...
              applicable laws, Invert Solar shall not be liable for the Comments
            ...
            <p>
              Invert Solar reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Invert Solar a non-exclusive license to use,
            ...
            <p>
              ...
              Invert Solar; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Invert Solar. Please include your name,
            ...
            <p>
              No use of Invert Solar’s logo or other artwork will be allowed for
